...
public record SurveyFormRequest(
        ...
        Double longitude,
        String remarks,
        @Valid PoleDetailRequest poleDetail,
        @Valid ConductorDetailRequest conductorDetail,
        @Valid TransformerDetailRequest transformerDetail,
        @Valid MeterDetailRequest meterDetail
) {}
